...
namespace MD5Controller
{
    public partial class mainForm : Form
    {
        ...
        private object PanelStartChatPanel;
        ...
        private void dropPanel_DragDrop(object sender, DragEventArgs e)
        {
            ...
            foreach (string file in files)
            {
                ...
                /*Get the MD5 Controller for the file and add to textbox*/
        ...
        {
            Process.Start(githubv.GITHUB_REPO_URL);
        }

        private void PanelStartLblVersion_Click(object sender, EventArgs e)
        {
            Process.Start(githubv.REPO_RELEASE_URL);
        }
